...
(40,'Tina', 'Underwood', '2001-09-22', 'Female', 'tina.underwood@example.com', '0001112222','123 Oak St');
 ...
 --insert values for course table
...
--insert values for enrollment table
...
--insert values for instructor table
...
select*from student where first_name like'ra___'
...
--use function-inbuilt(srf and mrf)
--use srf
--use length
